...
src-tauri/target/release/bundle/nsis/New API Desktop_1.1.4_x64-setup.exe
```
...
```bash
adb install -r src-tauri/gen/android/app/build/outputs/apk/arm64/release/New-API-Desktop_1.1.4_arm64-release.apk
```
